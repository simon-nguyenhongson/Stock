...
Workspace phục vụ theo dõi danh mục đầu tư **cá nhân** (HOSE/HNX/UPCoM + vàng SJC/nhẫn 9999) và sinh báo cáo briefing sáng. Đây **không phải** dữ liệu ngân hàng hay dữ liệu công việc.

## Lệnh

- `/briefing` — chạy toàn bộ quy trình briefing sáng: đọc `DANH_MUC.md`, thu thập tin tức + giá thị trường + giá vàng, lấy BCTC quý gần nhất từ 24HMoney, tính P&L và khoảng cách stop-loss/target, sinh `briefing.html`, cập nhật `DANH_MUC.md`, rồi mở báo cáo.
...
6. Báo cáo luôn viết **tiếng Việt có dấu**, mọi diễn giải là bullet point, mọi số liệu nằm trong bảng, và luôn kèm disclaimer "tham khảo, không phải khuyến nghị đầu tư".
...
| [bang_C2.md](bang_C2.md) | Bảng đồng bộ ngưỡng kích hoạt trigger |
| [chien_luoc_ve_bo.html](chien_luoc_ve_bo.html) | Dashboard chiến lược quản trị rủi ro & về bờ |
...
| [DANH_MUC_TEMPLATE.md](DANH_MUC_TEMPLATE.md) | Bản mẫu trống để khởi tạo danh mục mới |
