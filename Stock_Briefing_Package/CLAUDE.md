...
- `/briefing` — chạy toàn bộ quy trình briefing: đọc `DANH_MUC.md`, thu thập tin tức + giá thị trường + giá vàng, lấy BCTC quý gần nhất từ 24HMoney, tính P&L và khoảng cách stop-loss/target, sinh `briefing.html`, cập nhật `DANH_MUC.md`, mở báo cáo, rồi **commit & push toàn bộ lên git** (bỏ qua nếu thư mục không phải git repo).
